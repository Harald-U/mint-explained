...
<img src="{{ site.baseurl }}//assets/images/software/updates_available.png" alt="Shield" width="40">

Die Software-Aktualierung wird durch einen Klick auf dieses Icon gestartet.
